                ...
                <Container>
                    <Row align="center">
                        ...
                        <Col style={{ textAlign: 'right' }}>
                            ...
                            <ListaInline>
                                <ItemListaInline>
                                    <a href="/" aria-label="Link para WhatsApp"><IconeWhatsApp /></a>
                                </ItemListaInline>
                                <ItemListaInline>
                                    <a href="/" aria-label="Link para a Twitch"><IconeTwitch /></a>
                                </ItemListaInline>
                                <ItemListaInline>
                                    <a href="/" aria-label="Link para o Instagram"><IconeInstagram /></a>
                                </ItemListaInline>
                                <ItemListaInline>
                                    <a href="/" aria-label="Link para o Twitter"><IconeTwitter /></a>
                                </ItemListaInline>
                            </ListaInline>
                        </Col>
                    </Row>
